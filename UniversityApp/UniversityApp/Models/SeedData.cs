        ...
        public static void Initialize(IServiceProvider serviceProvider)
        {
                ...
                serviceProvider.GetRequiredService<DbContextOptions<UniversityAppContext>>()))
            {
                ...
                context.Enrollment.AddRange(
                  new Enrollment { CourseId = context.Courses.Single(c => c.Title == "Matematika").Id, StudentId = context.Student.Single(s => s.FirstName == "Stefan" && s.LastName == "Simonovski").Id, ExamPoints = 56, AdditionalPoint = 15, ProjectPoints = 23, SeminarPoints = 15, Year = 2020, Grade = 7, FinishDate = DateTime.Parse("2020 - 5 - 26") },
                  new Enrollment { CourseId = context.Courses.Single(c => c.Title == "Matematika").Id, StudentId = context.Student.Single(s => s.FirstName == "Mirko" && s.LastName == "Mirkovski").Id, ExamPoints = 70, AdditionalPoint = 15, ProjectPoints = 25, SeminarPoints = 15, Year = 2020, Grade = 8, FinishDate = DateTime.Parse("2020 - 5 - 26") }
                  );
