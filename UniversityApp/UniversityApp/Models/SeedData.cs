...
namespace UniversityApp.Models
{
    public class SeedData
    {
        ...
        public static void Initialize(IServiceProvider serviceProvider)
        {
            ...
            {
                // Look for any movies.
                if (context.Course.Any() || context.Professor.Any() || context.Student.Any() || context.Enrollment.Any())
                {
                ...
                context.Course.AddRange(
                    new Course { Title = "Matematika", Credits = 5, Programme = "Programa", EducationLevel = "Dificult", Semester = 1,
                ...
                context.Student.AddRange(
                    new Student { FirstName = "Stefan", LastName = "Simonovski", AcquiredCredits = 120, EducationLevel = "First Year", EnrollmentDate = DateTime.Parse("2018 - 9 - 3"), CurrentSemester = 3},
                    new Student { FirstName = "Mirko", LastName = "Mirkovski", AcquiredCredits = 100, EducationLevel = "First Year", EnrollmentDate = DateTime.Parse("2018 - 9 - 5"), CurrentSemester = 3 }
                    );
                context.SaveChanges();
